...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, tgt_vocab_size, d_model, num_heads, num_layers, d_ff, max_edge_count, max_seq_length, dropout):
        super(Transformer, self).__init__()
        self.encoder_embedding = nn.Embedding(src_vocab_size, d_model)
        self.decoder_embedding = nn.Embedding(tgt_vocab_size, d_model)
        self.tgt_positional_encoding = PositionalEncoding(d_model, max_seq_length)
        self.src_positional_encoding = PositionalEncoding(d_model, max_edge_count)
